...
<div className="bg-white shadow-sm rounded-2xl p-6 my-4 ">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Welcome back, Dr. Admin</h1>
            <p className="text-gray-600 mt-1">{formatDate(currentTime)}</p>
          </div>
          <div className="mt-4 sm:mt-0 text-right">
            <div className="text-3xl font-mono font-bold text-pink-700">{formatTime(currentTime)}</div>
        ...
        <div className="bg-white shadow-sm rounded-2xl p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium text-gray-800">{dashboardData.systemStatus.lastBackup}</span>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-medium text-gray-800">{dashboardData.systemStatus.storageUsed}%</span>
              </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium text-gray-800">{dashboardData.systemStatus.activeUsers} online</span>
            </div>
          </div>
        </div>
